...
const AllQAs=()=>{
    ...
    let filterSearch= state.list
    .filter((ques) => ques.tags.toLowerCase().includes(state.sfield.toLowerCase()) );
    
    if(state.displayUnsolved) filterSearch=filterSearch.filter((ques)=>!ques.satisfied)
    
    return (
    <div >
     <img src="https://visme.co/blog/wp-content/uploads/2017/07/50-Beautiful-and-Minimalist-Presentation-Backgrounds-021.jpg" alt="bgForQA" 
            className="bg-still" />
        <div className="container text-c"  >
            <SearchBar search={onSearch} /> 
            <div>
                <input className="form-check-input" onChange={toggleQues} type="checkbox" value="" id="defaultCheck1" />
