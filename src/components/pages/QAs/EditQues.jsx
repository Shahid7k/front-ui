...
const EditQues = () => {
  ...
  const initialQuesState = {
    ...
    photo: '',
    photoURL:
      'http://localhost:8080/qa/photo/' + quesId ||
      'https://lh3.googleusercontent.com/-Y2yb7fEEWGk/XtN3xsDvReI/AAAAAAAACyE/BSPh9_T_ow411IOXpKWMcgBP4DbAyJL3ACK8BGAsYHg/s0/2020-05-31.png',
  };
  ...
  const handleChange = e => {
    ...
    if (name === 'photo') {
      ...
      reader.onloadend = () => {
        fetchQues({ ...quesState, photo: file, photoURL: reader.result });
      };
        ...
        <form onSubmit={submit} encType='multipart/form-data'>
          <div className='mx-5'>
            <button
              ...
              title='To mark as Solved..Go to Edit and check on Solved!'
            >
