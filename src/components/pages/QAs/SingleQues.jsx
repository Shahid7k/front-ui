    ...
    if(redirect) return <Redirect to="/"  />
      return (
        <div className={`${condition?"bg-dark":"bg-mint-cream"}`}>
           ...
           <div className=" ">
               <h1 className=" font18 p-2  mx-5 px-5" style={mode}>{title}.</h1>
                        ...
                        <div className=" p-5" style={mode}>
                                {
                                   postedBy!=null ?
                                    (
                                        <NavLink to={`/profile/${postedBy._id}`} className="h6 font-italic">asked by - {postedBy.firstName} </NavLink>
                                    ):
                                    (
                            ...
                            {quesState.showAnswers && (quesState.answers.length!==0) && (
                                    quesState.answers.map((x,i) =>(<div key={i} className="p"> 
                                         <div key={i}   className="p-4 d-flex">
                                            ...
                                            {(x!==null && x!==undefined && x.postedBy!=null)?(<NavLink to= {`/profile/${x.postedBy._id}`} >
                                                    ...
                                                    <figure>
                                                         <img src="https://www.searchpng.com/wp-content/uploads/2019/02/Profile-PNG-Icon-715x715.png"
                                                            className="comment-photo rounded-circle"/>
                                                    </figure>
                                                 )}
                                            </div>
                        ...
                        <div className=" text-wrap ">
                            <div className="text-truncate">
                               <div className="h6 underline">
                                ...
                                {quesArr.filter(ques=> ques._id!==userId).map((ques,i)=><div key={i}><a href={`/question/${ques._id}`}className=" text-truncate"> {(ques.title.substring(0,20))} </a></div>)}
                            </div>
                        </div>
                    </div>
                </div>
